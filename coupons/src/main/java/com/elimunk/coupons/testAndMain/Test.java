//package com.elimunk.coupons.testAndMain;
//
...
//import com.elimunk.coupons.utils.BuildDbUtils;
...
////						"description No " + 000 + i, new Date(), DateUtils.parseDate("2019-05-1"+i), 6 + i, 8.5 * i, "Not yet") , 1);
////			}
//			
//			// create 4 purchases
//			System.out.println("\n----------  create 4 purchases  ----------\n");
...
//			// user login
//			System.out.println("\n----------  user login (id 1)----------\n");
//			UserIdTypeAndToken clientLoginTest = null;
